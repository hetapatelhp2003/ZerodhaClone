        ...
        <div className="container p-5">
            <div className="row p-5">
                ...
                <div className="col-6">
                    ...
                    <div className='text-center'><a href="" style={{textDecoration:"none"}}>Explore our products<i class="fa-solid fa-arrow-right"></i></a>
                    <a href="" className='mx-5 ' style={{textDecoration:"none"}}>Try kite</a></div>
                </div>
            </div>
        </div>
     );
